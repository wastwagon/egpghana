...
<img src="/assets/images/publications/imf-boss-farewell.jpg" alt="Group Photo" className="w-full h-auto rounded-xl my-6 shadow-md" />`,
        ...
        const events = [
            ...
            },
            {
                ...
                description: "We facilitated a collaborative session with Civil Society Organizations to gather inputs for the 2025 national budget.",
                location: "Accra International Conference Centre",
                startDate: new Date('2025-03-04T10:00:00'),
                endDate: new Date('2025-03-04T15:00:00'),
                featured: false,
            },
            {
                ...
                endDate: new Date('2025-05-15T12:00:00'),
                featured: false,
            },
            {
                ...
                endDate: new Date('2025-06-07T13:00:00'),
                featured: false,
            },
            {
                ...
                endDate: new Date('2025-06-21T17:00:00'),
                featured: false,
            },
        ];
